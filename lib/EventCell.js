      ...
      if (showAsAllDay) {
        ...
        if (employee != undefined) {
          titleFormmat =
            ...
            '.' +
            _lodash.default.first(employee.EmployeeLastName)
        }
      }

      if (renderContent !== undefined && renderContent === 'roster') {
        var _employee = _lodash.default.find(employees, {
        ...
        if (_employee !== undefined) {
          ...
          titleFormmat =
            ...
            '.' +
            _lodash.default.first(_employee.EmployeeLastName) +
            '\uFF1A' +
            startTime +
            ' - ' +
            endTime
