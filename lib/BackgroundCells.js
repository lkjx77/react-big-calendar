...
function (_React$Component) {
  ...
  _proto._selectable = function _selectable() {
    ...
    selector.on('touchstart', function (point) {
      return selectorClicksHandler(point, 'touchstart');
    });
    selector.on('touchend', function (point) {
      return selectorClicksHandler(point, 'touchend');
    });
    selector.on('mouseup', function (point) {
      return selectorClicksHandler(point, 'mouseup');
    });
    selector.on('mousedown', function (point) {
      return selectorClicksHandler(point, 'mousedown');
    });
