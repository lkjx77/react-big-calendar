...
function (_React$Component) {
  ...
  function DayColumn() {
    ...
    _this._selectable = function () {
      ...
      selector.on('touchstart', function (box) {
        return selectorClicksHandler(box, 'touchstart');
      });
      selector.on('touchend', function (box) {
        return selectorClicksHandler(box, 'touchend');
      });
      selector.on('mouseup', function (box) {
        return selectorClicksHandler(box, 'mouseup');
      });
      selector.on('mousedown', function (box) {
        return selectorClicksHandler(box, 'mousedown');
      });
