...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    events.map(function (event) {
      ...
      hours = hours + (_dates.default.diff(evtStart, evtEnd, 'minutes') / 60).toFixed(2);
    });
    return _react.default.createElement("div", {
      style: style,
      className: (0, _classnames.default)(className, 'rbc-day-slot', 'rbc-time-column', isNow && 'rbc-now', isNow && 'rbc-today', // WHY
      selecting && 'rbc-slot-selecting')
    }, _react.default.createElement("span", null, "HeadCount: (", events.length, ") "), _react.default.createElement("span", null, "Hours: ", hours), isNow && _react.default.createElement("div", {
      ref: "timeIndicator",
      className: ""
    }));
  };
