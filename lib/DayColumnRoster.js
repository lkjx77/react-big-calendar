...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    events.map(function (event) {
      var evtStart = _dates.default.max(event.start, min); // let evtEnd = dates.add(event.end, 59, "seconds")


      var evtEnd = _dates.default.min(event.end, max);

      if (evtEnd == _dates.default.subtract(max, 59, "seconds")) {
        evtEnd = _dates.default.add(max, 1, "seconds");
      }
    ...
    }, _react.default.createElement("span", null, "HeadCount: (", events.length, ") "), _react.default.createElement("span", null, "Hours: ", hours.toFixed(2)), isNow && _react.default.createElement("div", {
      ref: "timeIndicator",
      className: ""
    }));
  };
